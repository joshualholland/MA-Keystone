          ...
          <section className="row overflow-hidden no-gutters">
            <div className="col-12 col-xl-6 order-1 order-xl-0 contentContainer text-center">
              ...
              <p className="descContent">
                ...
                the most precise and personalized look for each client. We
                believe in education being at the core of how we achieve this.
                We are always learning the newest techniques and trends so we
                can provide you with the best! Our team receives in house
                education as well as being sent to New York to attend the most
                inspiring and creative classes at the House of Bumble with our
          ...
          <section className="row overflow-hidden no-gutters">
            ...
            <div className="col-12 col-xl-6 contentContainer text-center">
              ...
              <p className="descContent">
                ...
                Morgan Ashley by giving back to our community and reaching out
                to those in need around us. We feel so honored to get to partner
                with various ministries and individuals who are making a
                difference in our community. This is us and the heart of Morgan
                Ashley.
              </p>
            </div>
          </section>
